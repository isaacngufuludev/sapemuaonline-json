function ProfessoresItem({ item }) {
  return (
    <li className="border-stone-200 border-[0.1px] p-6 flex flex-col rounded-md dark:border-stone-900 min-w-[350px]">
...
export default ProfessoresItem;
