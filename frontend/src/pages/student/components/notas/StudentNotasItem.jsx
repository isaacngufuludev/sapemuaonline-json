function StudentNotasItem({ item, i }) {
  ...
  return (
    <li className="items-center text-sm font-semibold p-4 border-t-[0.1px] dark:border-gray-700 border-slate-200 grid grid-cols-[0.3fr_2fr_1fr_1fr_1fr_1fr]">
      <p className="font-semibold rounded-full w-2/4 flex items-center justify-center py-2 px-5 bg-slate-100  dark:bg-gray-900">
        {i + 1}
      </p>
      <p>{item.disciplina}</p>
